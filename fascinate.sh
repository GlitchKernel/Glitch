...
#../../../device/samsung/aries-common/mkshbootimg.py release/boot.img arch/arm/boot/zImage Glitch-Ramdisks/fascinatemtd/ramdisk.img Glitch-Ramdisks/fascinatemtd/ramdisk-recovery.img
