...
PATCHLEVEL = 6
SUBLEVEL = 35
EXTRAVERSION = .13_Glitch-V13-REL
NAME = Yokohama
...
GLITCHFLAGS = -finline-functions -fgcse-after-reload -ffast-math -fsingle-precision-constant -pipe -march=armv7-a -mtune=cortex-a8 -mfpu=neon -ftree-vectorize -mfloat-abi=softfp --param l2-cache-size=512 --param l1-cache-size=64 --param simultaneous-prefetches=8 --param prefetch-latency=200 --param l1-cache-line-size=64 -fsched-spec-load-dangerous -fpredictive-commoning -fira-coalesce -funswitch-loops -ftree-loop-im -fipa-cp-clone -mvectorize-with-neon-quad -fvect-cost-model
