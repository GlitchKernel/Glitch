...
#../../../device/samsung/aries-common/mkshbootimg.py release/boot.img arch/arm/boot/zImage Glitch-Ramdisks/captivatemtd/ramdisk.img Glitch-Ramdisks/captivatemtd/ramdisk-recovery.img
